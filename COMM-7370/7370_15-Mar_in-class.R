...
setwd("C:/Users/SaraK/...") # Needs to be set
...
## Reading Data into R -----------------------------------------------------
rawdata <- read_csv("7800_practice-data.csv")
# Cleaning data
rawdata %>%
        freq(gc)
wdata <- rawdata %>%
...
wdata <- wdata %>%
        mutate(cM2_3 = case_when(M2_3 == "None 0" ~ 0,
                                 M2_3 == "1" ~ 1,
                                 M2_3 == "2" ~ 2,
                                 M2_3 == "3" ~ 3,
                                 M2_3 == "4" ~ 4,
                                 ...
                                 M2_3 == "9" ~ 9,
                                 M2_3 == "A lot  10" ~ 10,
                                 M2_3 == "-99" ~ NA_real_)) # vs NA_character_
wdata %>%
        freq(cM2_3)
...
wdata <- wdata %>%
        mutate(cM3_3 = case_when(M3_3 == "None  0" ~ 0,
                                 M3_3 == "1" ~ 1,
                                 M3_3 == "2" ~ 2,
                                 M3_3 == "3" ~ 3,
                                 M3_3 == "4" ~ 4,
