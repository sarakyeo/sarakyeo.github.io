...
A **parameter** is a value (e.g., mean, standard deviation) that describes a population. Parameters are estimated from sample statistics. Do not worry, we will cover this term again next week and more fully define it. For now, let's use an example to understand the difference between confidence intervals and confidence level.
...
The above logic can also be used to determine your sample size: <mark>Once you know how much error you can/are willing to tolerate, you can calculate the number of cases required in a sample.</mark>
...
You may have heard this term used in the 2016 Presidential election (see, for example, [this article in The New York Times](https://utah.instructure.com/files/123052932/download?download_frd=1)).

Read this [report](https://utah.instructure.com/files/123052922/download?download_frd=1) by the American Association for Public Opinion Research (AAPOR) about weighting.
