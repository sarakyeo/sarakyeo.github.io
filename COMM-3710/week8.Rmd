...
knitr::include_graphics("https://sarakyeo.github.io/images/sample-design.gif")
...
```{r, param-stat, echo=FALSE, message=FALSE, warning=FALSE, out.width = "100%", fig.align='center'}
...
> You may have heard this term used in the 2016 Presidential election (read [this article in The New York Times](https://utah.instructure.com/files/131421329/download?download_frd=1)).

> Read this [report](https://utah.instructure.com/files/131421340/download?download_frd=1) by the American Association for Public Opinion Research (AAPOR) about weighting.
