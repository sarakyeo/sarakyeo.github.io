...
<center>
<iframe width="560" height="315" src="https://www.youtube.com/embed/RlR9PgDAYkA" data-external="1" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</center>
<br>
...
Using the data and formula above, calculate a value of $\chi^2$. Step-by-step instructions can be found in Chapter 15 of your textbook.
...
Follow the [step-by-step approach in your textbook](https://online.vitalsource.com/#/books/9780190861940/epubcfi/6/50%5B%3Bvnd.vst.idref%3Dc17%5D!/4/2/20/2/2%5Bhead647%5D%400:0) to calculate a test statistic. Remember that your data are different from those in the textbook.
...
```puppies %>% tukey_hsd(Happiness ~ Dose)```
