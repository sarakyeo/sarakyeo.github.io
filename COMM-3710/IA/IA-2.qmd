...
1) List the reference(s) of the journal articles in APA format.<!-- 2 points -->

2) For each concept, find and describe (in your own words) its working definition from the appropriate journal article. Be sure to cite the journal article in APA format in your answer.<!-- 3 pts -->
<!-- talk about citing; refer the to Purdue OWL -->
