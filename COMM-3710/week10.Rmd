...
State1 <- c("USA", "Arizona", "California", "Colorado", "Idaho", "Montana")
State2 <- c("Nevada", "New Mexico", "Oregon", "Utah", "Wyoming", "")
Pop1 <- c(334735155, 7151502, 39538223, 5773714, 1839106, 1084225)
Pop2 <- c(3104614, 2117522, 4237256, 3271616, 576851, "")

censusdata <- tibble(State1, Pop1, State2, Pop2)
censusdata %>% 
        kbl(., format.args = list(big.mark = ","),
            col.names = c("", "Population", "", "Population"),
