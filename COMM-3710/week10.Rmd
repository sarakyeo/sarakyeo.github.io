...
Recall that in our lecture on **Sampling**, we briefly defined the term, **parameter**. After reading this section, revisit [last week's lecture](https://sarakyeo.github.io/COMM-3710/week8.html) to see if the definitions of the terms, *confidence interval* and *confidence level*, make more sense.
...
Recall (from [Week 8](https://sarakyeo.github.io/COMM-3710/week8.html)) that a **sample** consists of the units (in the case of survey research, people) that are included in a study. The **population**, on the other hand, is the entire group in which a researcher is interested. The population is a theoretically specified aggregation of the units (i.e., people) in the study.
...
# Descriptive vs. Inferential Statistics {.tabset .tabset-fade}
...
> Descriptive statistics are used to provide researchers with a **description** of what "exists" in the data.

Percentages and averages are types of descriptive statistics. Consider the table with population estimates for the western U.S. again. Approximately 1% of the American population lives in Utah while 12% live in California. You can easily see how this comparison would be difficult without descriptive statistics.
