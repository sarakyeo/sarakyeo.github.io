...
Examine the figure above again. Notice that the figure showing the central dogma consists of a population and a sample. **Statistics are numbers that describe characteristics of samples** while **parameters describe populations**.
