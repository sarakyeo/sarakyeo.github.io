...
For example, Professor Yeo is interested in understanding how American adults form opinions about scientific issues. In this case, the population of interest is every adult in the U.S. above 18 years old. In order to calculate statistics that will allow her to estimate the corresponding parameter in a population, she must first collect a sample. It would be impossible to measure attitudes toward a scientific issue for everyone in the U.S.!
