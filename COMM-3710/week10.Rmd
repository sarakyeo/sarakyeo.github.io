...
Recall that in our lecture on **Sampling**, we briefly defined the term, **parameter**. After reading this section, revisit [the lecture from Week 8](https://sarakyeo.github.io/COMM-3710/week8.html) to see if the definitions of the terms, *confidence interval* and *confidence level*, make more sense.
