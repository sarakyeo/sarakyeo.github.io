...
```{r, solomon, echo=FALSE, message=FALSE, warning=FALSE, out.width = "80%", fig.align='center', fig.cap = "Basic experimental design."}
...
```{r, solomon-basic, echo=FALSE, message=FALSE, warning=FALSE, out.width = "100%", fig.align='center', fig.cap = "Solomon four-group design."}
