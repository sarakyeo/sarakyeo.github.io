...
Load the packages below into R. Then, read the [HELP](https://utah.instructure.com/files/123052929/download?download_frd=1) data set into R. This data set is saved as a .csv file.
