...
Load the [HELP](https://utah.instructure.com/files/117853074/download?download_frd=1) data set into R. This data set is saved as a .csv file.
...
a. How many patients are between the ages of 40 and 45 whose primary substance of abuse is cocaine?
...
## Hint
To create a new variable, we need to first check the frequency distributions of each variable that comprises the one you will create. In general, it is good practice to examine the frequency distributions of all variables before working with them.
