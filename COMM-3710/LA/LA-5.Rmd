...
## Hint
The code below subsets the data to include only patients who are housed (we did this in LA-4, if you need a reminder). We could also combine two criteria for filtering into one command.
