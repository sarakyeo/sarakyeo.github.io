...
# Instructions
1. Familiarize yourself with the CPS documentation above. Then, load the [CPS data set](https://utah.instructure.com/files/108105224/download?download_frd=1) in R.
...
3. Implement the appropriate statistical test to determine whether males have significantly higher wages earned per hour than females. Use the chart from [LA.6](https://sarakyeo.github.io/COMM-3710/LA/LA.6.html) to guide your choice of statistical test.
...
6. Submit the following on Canvas.
