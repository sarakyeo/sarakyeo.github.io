...
1) Download the full COVID dataset (`covid-full.csv`) and codebook (`covid-full-codebook.csv`). Use the codebook to familiarize yourself with the variables in the data and read the data into R.
...
#6: r = 0.20, p < .001. There is a positive relationship between respondents' frequency of wearing masks outside and the number of days since the COVID-19 outbreak. This makes sense as we learned more about the virus over time.
