...
Then, read the [Utilities.csv](https://utah.instructure.com/files/123052907/download?download_frd=1) data set into R and re-familiarize yourself with the variables using the codebook.
