...
Before starting this assignment, watch the following video: https://youtu.be/b9Bh3K5bi0I. Additional resources for R can be found [here](https://rpubs.com/yesun/652965).
...
3. Make a new variable `SuicidalThought` based on the variable `g1b`. Have 1 indicate a patient has had suicidal thoughts and a 0 indicate they have not. **Hint:** You can use the same logic from the command in Q2 to create this variable. If you need help with the `ifelse` command, type `?ifelse` in the Console window of RStudio. 

4. Make a new variable `HomelessStatus` based on the variable `homeless`. Have 1 indicate that a patient is homeless and 0 indicate that they are housed. **Hint:** See Question 2.
