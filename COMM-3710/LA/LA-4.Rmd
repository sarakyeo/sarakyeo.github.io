...
## Instructions
Download the [HELP dataset](https://utah.instructure.com/files/117853074/download?download_frd=1) and copy and paste it into your working directory.

Read the HELP data into a data frame in R (give the data frame a name of your choice). View the HELP data set in the Console and answer the questions below.
