...
## Instructions
Using `%>%` and the `freq()` function instead of `mean()`, answer the questions below.

a) Among respondents who are male, how many reported their primary substance of abuse to be **alcohol**, **cocaine**, and **heroin**?
b) Among respondents who are female, how many reported their primary substance of abuse to be **alcohol**, **cocaine**, and **heroin**?
