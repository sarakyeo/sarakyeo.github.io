...
## Hint
Start by identifying the variables (which variable will you use to filter or select cases? Which varaible will be used in the `count()` function) that you will use in this code chunk. Then, write pseudocode detailing the steps you need to take to arrive at answers for a, b, and c. Finally, write your R commands using the pipe operator. Remember that each line of code must have a comment.
