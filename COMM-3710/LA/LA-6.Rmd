...
# Bonus (1 point) {.tabset .tabset-fade}
## Instructions
Determine the mean number of risk factors for patients whose primary substance of abuse is (a) alcohol, (b) cocaine, and (c) heroin.

---

## Hint
Use the `group_by()` and `descr()` functions to get the answers to (a), (b), and (c).
