...
Note that you do **not** need quotation marks if you are recoding a variable to be numeric. We are using numbers, `0` and `1`, to denote whether a patient is at risk or not. You might want to review the lecture content on [Measurement](https://sarakyeo.github.io/COMM-3710/week4.html#Measurement), paying close attention to **Aspects of Variables**.
