...
Make a new variable called `ExtremeMCS` and code it as `high` if a patient is at risk based on his/her mcs score and `low` otherwise. Then, answer the following questions.

a) How many patients are thought to be at extreme risk of returning to the detoxification unit within the next 12 months?
b) What percentage of patients are not at extreme risk of returning to the detoxification unit within the next 12 months?
