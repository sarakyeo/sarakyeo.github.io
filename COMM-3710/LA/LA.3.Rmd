...
To load/read data into R, see [Chapter 3](https://sarakyeo.github.io/COMM-3710-bookdown/docs/setup.html) of the book, COMM 3710: Getting Started with R.
...
The code below to see a frequency distribution for the variable `racegrp` in the HELP data set, which has been read into a data frame called `hdata`.
...
knitr::include_graphics("LA.3_sample-R-submission.png")
```
