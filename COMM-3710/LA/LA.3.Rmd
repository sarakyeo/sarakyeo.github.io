...
## Instructions
Before you begin, watch this [video](https://youtu.be/Dbj_l1PRIjA) on working with R. Additional resources can be found [here](https://rpubs.com/yesun/652965).

1. Load in the [HELP.csv data set](https://utah.instructure.com/files/108105219/download?download_frd=1)<!--change link for each section-->, which can be found on Canvas. **Hint:** The command to read a .csv data file to an object named `helpdata` in R is `helpdata <- read.csv("HELP.csv")`.
