...
**Submit a single PDF document that contains the two (2) screenshots on Canvas.** Example screenshots can be found after the instructions.
...
**Submit the R commands that you used to arrive at your answer to Question 4.  