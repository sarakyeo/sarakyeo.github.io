...
2) Use the function `max()` to find the greatest highest point (in meters) of all the ski resorts in the dataset. What is the highest point (m) and in which ski resort is this highest point?

3) Which resort has the fewest number of lifts?
