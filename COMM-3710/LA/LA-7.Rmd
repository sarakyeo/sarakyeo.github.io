...
## Instructions
Download and save the [Utilities](https://utah.instructure.com/files/123052907/download?download_frd=1) dataset into your working directory.
...
# Step 2 
Using the [Utilities](https://utah.instructure.com/files/123052907/download?download_frd=1) data, read and follow along with [Chapter 5 of COMM 3710: Getting Started with R](https://sarakyeo.github.io/COMM-3710-bookdown/docs/ggplot2.html).

Although there are no questions in this assignment related to this chapter, be sure to follow along with the text; learning by doing is best when starting to work with R and RStudio. <span style="color: blue;">**Do not skip this step. It will help you understand `ggplot`.**</span>
...
Then, use the `mean()` function to calculate the average gas bill for that month. Type `?mean` into the Console and read the documentation for this function. Remember to strip NA values from your computation by using the argument, `na.rm = TRUE`. If necessary, refer to your code in previous assignments.
