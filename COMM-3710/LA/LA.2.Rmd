...
- Select 4 variables recorded on the medical forms (one should be a unique identifier, at least one should be a quantitative variable and at least one should be a categorical variable). A **quantitative variable** is one that has numerical values with consistent intervals (e.g., weight, temperature). A **categorical variable** is one with names or labels that have no logical order (e.g., eye color, ice cream flavors).
