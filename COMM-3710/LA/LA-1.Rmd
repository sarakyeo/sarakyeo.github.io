...
## Step 3
Follow the instructions in [Sections 2.1 and 2.2](https://sarakyeo.github.io/COMM-3710-bookdown/docs/start.html#install) to install R and RStudio. Then, watch this [video](https://rstudio.com/products/rstudio/?wvideo=520zbd3tij) to learn how to navigate RStudio. **Take a screenshot of RStudio and save it**.
...
**All files related to this course should be stored in this working directory. Take a screenshot of your working directory and save it.**
...
**Submit a screenshot of the R commands in RStudio that you used to arrive at your answer to Question 4. This screenshot should include all three objects from Questions 1-3 and the answer to Question 4.**
