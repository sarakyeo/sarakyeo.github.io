...
---
title: "LA4: Data Wrangling"
pagetitle: "COMM 3710: LA4"
output:
html_document:
toc: true
toc_float: true
...
6) Now that we know the dimensions of our data frame (i.e., rows/cases, columns/variables), let's get a little more familiar with these data. 
...
Description <- c("The day of the month that this performance's week ended on.",
                 ...
                 "The year that this week of performances occurred in.", "The name of the production.",
                 "The name of the theater.",
                 "Whether it is a Musical, Play, or Special.",
                 "The total number of people who attended performances over the week.",
                 "The percentage of the theater that was filled during that week.",
                 "The 'Gross Gross' of this performance, or how much it made in total across the entire week. Measured in dollars.",
                 "The Gross Potential is the maximum amount an engagement can possibly earn.",
                 "The number of performances that occurred this week.")

df <- tibble(Variable,  Description)

df  |>  
        kable(caption = "Codebook for the broadway dataset.")  |>  
...
# Note that na.rm = TRUE removes NAs (i.e., missing values) from the calculation of the mean, if there are any in your dataset. We don't have those in this dataset, though.
...
b |> # Start with the braodway data frame
...
# 5a: min = 87141 USD, max = 1051850 USD, M = 460019.7 USD
# 5b: min = 67578 USD, max = 1247155 USD, M = 561461.1 USD
