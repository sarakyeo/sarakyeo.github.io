...
Next, translate the pseudocode to R functions using the pipe operator and calculate the mean attendance for *Mamma Mia!*.
...
Using the calculations performed by the R commands above, answer the following questions:
   ...
   d) What is the minimum number of people who attended Mamma Mia!?
   e) What is the maximum number of people who attended Mamma Mia!?
   f) What is the mean number of people who attended Mamma Mia!?

:::callout-note   
There is a single function that is part of the package, `summarytools`, that will enable you to obtain these statistics with a single function. For 2 bonus points, try to figure out this function and use it in this exercise.
:::
...
8) Use the same logic and process from the example above to answer the following questions.
...
9) Using `|>` and the functions you just learned, write R code to determine the answers to the questions below. Round your answer to the nearest whole dollar.
