...
1. Group Project Code of Conduct (**one submission per group**) <!-- Clearly written code that is signed by all group members = 5 pts -->
2. CITI Training (**one submission per group that contains all group members' certificates of completion**) <!-- Certificates from all group members attached in one pdf  = 1 pts; Certificates showing all group members completed and passed CITI training = 4 pts -->
...
To complete this part of GP.A, **submit a signed (by all group members) PDF document detailing your group's Code of Conduct on Canvas**. Be sure to revisit this as necessary throughout the semester.
...
12. Once you have completed the modules, click “Print Report.” **Save the resulting report as a PDF file**. An example report can be found [here](https://utah.instructure.com/files/108105205/download?download_frd=1).
