...
List the hypothesis test chosen and provide a rationale for your decision in the PDF submission (see Example tab).
...
You will also need to include all commands to set up and conduct hypothesis testing for each hypothesis and/or research question in your R script. 


## Step 4 {.tabset .tabset-fade .tabset-pills}
### Question 
Interpret your findings and write a paragraph about each. Report your results after each hypothesis and rationale for the hypothesis test you chose.

The order in your PDF should be:

- Hypothesis/Research question
- Identification of hypothesis test used and rationale for choice of hypothesis test.
- Report results from hypothesis test.
