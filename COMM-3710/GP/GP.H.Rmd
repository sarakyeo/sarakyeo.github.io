...
**Submit your poster as a PDF document on Canvas using the template provided below**.
...
Posters can be created in PowerPoint or Adobe Illustrator. An example poster that you can use as a template can be found [here](https://utah.instructure.com/files/108105236/download?download_frd=1). The Marriott library [guidelines](https://campusguides.lib.utah.edu/posters) are detailed and helpful (especially [tips for graphic design](https://campusguides.lib.utah.edu/c.php?g=160626&p=1051976)). 
