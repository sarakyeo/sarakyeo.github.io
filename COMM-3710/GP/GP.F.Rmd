...
I encourage you to check out the [R Graph Gallery](https://www.r-graph-gallery.com/) for inspiration for your own graphs.

## Step 1
Load your data set and the following packages in R:
...
Using `ggplot2`, create univariate graphs of all your independent and dependent variables. Include the graphs in your PDF submission and all R commands and annotations in your script.
