---
title: "GP.I: Reporting Research (15 points)"
output:
...
GP.I is a culmination of your work over the course of the semester. You will use your work in GP.A through GP.H to put your poster together. A poster is essentially an abridged version of a research paper. Your poster should have a list of references in APA format.

Submit your poster as a PDF document on Canvas. Remember to include your **names and UofU email addresses** in your poster.

## Poster Requirements
Posters can be created in PowerPoint or Adobe Illustrator. And example poster that you can use as a template can be found [here](https://utah.instructure.com/files/104598929/download?download_frd=1). The Marriott library [guidelines](https://campusguides.lib.utah.edu/posters) are detailed and helpful (especially [tips for graphic design](https://campusguides.lib.utah.edu/c.php?g=160626&p=1051976)). 
...
* Describe your data set.
    * Include the name of the data set and at least 3 key features of the sample or way data were collected.
    * Include descriptive statistics about the demographics of your sample. 
* Describe your measures (i.e., variables) of interest.
...
* Reduce font size so you can get all references on one page. 
