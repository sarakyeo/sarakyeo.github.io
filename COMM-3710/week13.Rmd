...
> We are also learning how to select and conduct statistical tests in R in LA-8, which was assigned last week (Week 12, 28-Mar) via Canvas.
...
Because R is open-source software, packages are continuously being developed by people all over the world. You are welcome to use these packages but they will not be taught in this course. <mark>If you **do** use another package, ensure that the answers you get from using it are correct by checking them with the strategies shown in this course.</mark>