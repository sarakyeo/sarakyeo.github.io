...
title: |
  ...
  | \vspace{0.5cm} \large Spring 2022
  | University of Utah
...
lab_data %>%
        kbl(., booktabs = TRUE,
            col.names = c("Section", "TA", "Day", "Time (MT)", "Email", "Location"))

```


## Office Hours
Both TAs and Prof. Yeo will have weekly office hours.

```{r, office-hrs, echo=FALSE, message=FALSE, warning=FALSE}
Instructor <- c("Prof. Yeo",
                "Yi Liao",
                "Dallin Adams")
offtime <- c("Th 10 - 11 am",
          "F XX - XX a/pm",
          "Th XX - XX pm")
Link <- c("https://utah.zoom.us/j/95921224902 (Passcode: COMM3710)",
          "",
          "")
...
officehrs %>%
        kbl(.,booktabs = TRUE,
            col.names = c("Instructor", "Time (MT)", "Zoom Link"))
...
> **It is important that you pay close attention to the assignment due dates on Canvas.**

<!-- --- -->

## Lab Attendance
This course has two graduate [teaching assistants] for four lab sections. When you enrolled in this course, you selected a lab section to attend. You must attend at least **6 labs in-person throughout the semester. You must attend the lab section in which you are enrolled**.

If you show up to a lab section in which you are not enrolled, your attendance will not count toward your grade and you will be asked to leave. Additionally, if you are late to lab, your attendance will not count toward your grade.
...
- I urge non-participants to withdraw from the course to avoid receiving a failing grade (see the University's [Academic Calendar](https://registrar.utah.edu/academic-calendars/fall2021.php) for withdrawal deadlines). **Any future work such students might choose to submit may not be evaluated**.
...
sp2022 <- read_csv("3710_spring-2022.csv")
sp2022 %>% 
        kbl(., booktabs = TRUE) %>% 
        kable_styling(position = "center")
