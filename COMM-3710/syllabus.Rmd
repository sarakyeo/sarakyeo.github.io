...
title: |
  | <a name="top"></a>
  | COMM 3710-091: Quantitative Research
...
1. Reliable access to a laptop or desktop computer. A mobile device (tablet, phone) will not be sufficient to complete this course.
2. Internet access fast enough to stream videos and connect to online meetings.
3. A working webcam and microphone for online Zoom meetings.
4. An Internet browser compatible with Canvas.For more information, see this [page](https://community.canvaslms.com/docs/DOC-10720-67952720329).
...
* You should also be familiar with Zoom. If you need help with Zoom, check out these [tutorials](https://support.zoom.us/hc/en-us/articles/206618765-Zoom-video-tutorials).
* You should check your University email account regularly
...
## Individual Lab Assignments (80 pts)
There are 8 lab assignments. Information on individual lab assignments will be provided on Canvas. **Late assignments will not be accepted**. 

## Discussion Board Participation
Your participation in the discussions on Canvas will be part of your overall course grade. You will be assessed based on the quality and professionalism of your interactions with your peers and instructor(s). Be sure to check the discussions frequently and ask and/or respond to questions as appropriate. You are part of a learning community in this course and are expected to be an active participant in this community. It is not enough to just log on to Canvas and leave a brief comment, the quality of your participation matters. High quality participation involves asking questions and making comments that are informed by the readings and course content, pertinent to subject matter, and respectful of your peers’ views. Engaging in meaningful and substantive discussion with other students is an important aspect of high-quality participation. **Irrelevant remarks and questions that are uninformed by the course readings and materials do not count and may even be detrimental to your grade**. See note on course civility below.
...
# Virtual Office Hours <!--fill in information here-->
There are two sections of COMM 3710 that are using R this semester, sections 091 and 0XX. Even though you are enrolled in COMM 3710-091 (i.e., section 091), you may drop-in to the office hours of the TAs teaching COMM 3710-0XX. Office hours will be held virtually each week.
\begin{tabular}{ l l l l }
COMM 3710-091 & Prof. Sara K. Yeo & Tuesdays, 2:00 - 3:00 pm & https://utah.zoom.us/j/91491123002 \\
COMM 3710-0XX & Liz Giorgi & DAY, TIME & LINK \\
COMM 3710-0XX & Dallin Adams & DAY, TIME & LINK \\
\end{tabular}
...
The University of Utah values the safety of all campus community members. To report suspicious activity or to request a courtesy escort, call campus police at 801-585-COPS (801-585-2677).
...
## Week 6 (1-Mar): Participation Checkpoint
