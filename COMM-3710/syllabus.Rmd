...
*Note: LA = individual lab assignment, GP = group project component. The schedule below does not list due dates of individual lab assignments (LA) and group project components (GP). Due dates for these can be found on Canvas.*
