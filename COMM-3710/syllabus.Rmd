...
- This book is free and accessible via the link provided above.
...
You will also need access to [Canvas](https://utah.instructure.com/) and your [University email account](https://www.umail.utah.edu). I expect you to check the course Canvas website regularly. Announcements, assignments, readings, etc., will be posted there. You should be familiar with Canvas. If you need help with Canvas, visit the [Canvas Getting Started Guide for Students](https://community.canvaslms.com/docs/DOC-10701).

You should also check your University email account regularly. Be sure to review the [course email policies](#policies) as necessary throughout the semester.
...
## Quizzes (100 pts)
Quizzes will be administered on Canvas. All quizzes will be based on assigned readings and lectures. **Under no circumstances will make-up or late quizzes be administered**. You have until the end of the week to complete each quiz. There are 13 quizzes, each worth 10 points.
...
## Individual Lab Assignments (130 pts)
There are 13 individual assignments. Information on individual assignments will be provided on Canvas. **Late assignments will not be accepted**.

---

## Lab Attendance
This course has two graduate teaching assistants (TAs) for four lab sections. 
...
lab_data <- tibble(Section, TA, Day, Time, Location)
lab_data %>% 
  kbl() %>% 
  kable_minimal("hover", full_width = FALSE)
```
When you enrolled in this course, you selected a lab section to attend. You must attend at least **6 labs throughout the semester. You must attend the lab section in which you are enrolled**.
