...
title: |
  ...
  | \vspace{0.5cm} \small TAs: Yi Liao (u1368483@utah.edu) & Dallin Adams (dallin.adams@utah.edu)
output:
...
For [lab attendance] policies, review the [course requirements].
...
For each lab you attend, you will earn two (2) points toward your attendance grade (up to 10 pts). If you are more than **5 min** late to lab, you will only earn one (1) point toward your attendance grade.
...
- Non-participants are urged to withdraw from the course to avoid receiving a failing grade (see the University's [Academic Calendar](https://registrar.utah.edu/academic-calendars/fall2021.php) for withdrawal deadlines). **Any future work such students might choose to submit may not be evaluated**.
...
knitr::include_graphics("3710-spring-2022_schedule.png")
