...
In addition to your TAs, [The Learning Center](https://learningcenter.utah.edu) has a tutor for COMM 3710. You may schedule an appointment with Kenzie Smith using this [link](https://utah.craniumcafe.com/kenziesmith1).
...
If you show up to a lab section in which you are not enrolled, your attendance will not count toward your grade and you may be asked to leave. Additionally, if you are late to lab, your attendance will not count toward your grade.
...
- I urge non-participants to withdraw from the course to avoid receiving a failing grade (see the University's [Academic Calendar](https://registrar.utah.edu/academic-calendars/fall2021.php) for withdrawal deadlines). **Any future work such students might choose to submit will not be evaluated**.
...
grade <- c("A", "A-", "B+", "B", "B-", "C+", "C", "C-",
           "D+", "D", "D-", "F")
prange <- c("93 to 100", "90 to < 93", "87 to < 90",
            "83 to < 87", "80 to < 83", "77 to < 80",
            "73 to < 77", "70 to < 73", "67 to < 70",
            "63 to < 67", "60 to < 63", "< 60")

grade_data <- tibble(grade, prange)

grade_data %>% 
  kbl(col.names = c("Grade", "Range")) %>% 
  kable_minimal("hover", full_width = FALSE)
```
