...
- Non-participants are urged to withdraw from the course to avoid receiving a failing grade (see the University's [Academic Calendar](https://registrar.utah.edu/academic-calendars/spring2022.php) for withdrawal deadlines). **Any future work such students might choose to submit may not be evaluated**.
