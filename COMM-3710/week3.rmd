...
Concept explication is a cyclical process (see GIF below). Through concept explication and iterations of meaning and empirical analysis, we can refine our definitions, which in turn inform the observations we make.
