...
In the section titled [Steps in Meaning Analysis], we introduced two new terms related to **concepts**: <mark>dimensions</mark> and <mark>indicators</mark>.

For clarity, the three terms and their definitions are listed below. The GIF beneath that shows an example of each.
