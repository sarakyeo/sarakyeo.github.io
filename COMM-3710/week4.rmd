...
Levels of measurement allow us to have precision when we measure variables. The **level of measurement** refers to the relationship among values assigned to the attributes of a variable.

If necesary, refer to <a href="#var">What is a Variable?</a> to review the definitions of *variable attribute* and *variable value*.
