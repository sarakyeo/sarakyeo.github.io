...
As a guide, Fink (2006)^[Fink, A. (2006). *How to conduct surveys: A step-by-step guide* (3rd ed.). Thousand Oaks, CA: Sage.] suggests five steps for conducting a survey. Although the tabs below offer some idea of each step, be sure to read your textbook for more details.
