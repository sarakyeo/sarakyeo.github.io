...
3) A **response rate** is the proportion of surveys completed relative to the number of surveys distributed. For example, if you hand out 1,000 surveys and 950 are returned, your response rate is 95%. This high of a response rate is rare. In the real world, response rates are commonly below 50%. In fact, they are more likely to range between 15% and 35%, depending on the type and length of survey, as well as they type of sample. **It is important for survey researchers to be consider response rates when designing surveys**. Read about the different types of nonresponse, **unit nonresponse** and **item nonresponse**, in your textbook (Chapter 9).
