...
`r emo::ji('computer')` Currently, I have two projects funded by the [National Science Foundation](https://nsf.gov/)--[one on science humor](https://www.nsf.gov/awardsearch/showAward?AWD_ID=1906864) and [another in collaboration with PBS Digital Studios](www.nsf.gov/awardsearch/showAward?AWD_ID=2120006).
