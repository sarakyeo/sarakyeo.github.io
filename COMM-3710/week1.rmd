...
My CV and more information is available on my [faculty page](https://faculty.utah.edu/~sarakyeo). If you're interested in science communication research, please get in touch ([sara.yeo@utah.edu](mailto:sara.yeo@utah.edu)).
...
>
> **You will not receive a response to emails sent from a non-University account (e.g., Google, Yahoo, etc.)**.

Using a non-University account runs the risk of your message being diverted to Spam and your message may not reach me in a timely fashion, if at all. Emails should be written clearly and professionally with correct spelling and grammar.

**Emails that do not conform to these rules will not receive a response**.
