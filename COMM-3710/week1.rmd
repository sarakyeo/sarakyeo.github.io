...
Prof. Sara K. Yeo is an Associate Professor in the Department of Communication. She is an expert in survey research and experiments, and primarily conducts research in science communication. You can check out some of her work [here](https://orcid.org/0000-0002-2043-8400). Currently, she has two projects funded by the [National Science Foundation](https://nsf.gov/)--[one on science humor](https://www.nsf.gov/awardsearch/showAward?AWD_ID=1906864) and [another in collaboration with PBS Digital Studios](www.nsf.gov/awardsearch/showAward?AWD_ID=2120006).
