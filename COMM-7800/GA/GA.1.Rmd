...
Load/Read the [HELP](https://utah.instructure.com/files/117538823/download?download_frd=1 %>% ) data set into R and SPSS. This data set is saved as a .csv file. Include the code for loading data into R in your R script. You do not need to include the data import syntax for SPSS. Instead, you can use the GUI to load .csv data into SPSS.
