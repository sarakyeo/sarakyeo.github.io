...
Install the `summarytools` and `tidyverse` packages in R. Then, load the packages. You will not need any add-ons for SPSS.

Make a frequency table for `sex` and `d1`. Use these frequency tables to answer the questions below.
...
b. How many patients in this subset are between the ages of 40 and 45?


## Step 4 
Make a frequency table for `sex` based on this subset. Answer the questions below.

a. What percentage of patients who are at least 40 years old and have cocaine listed as his/her primary abuse substance are male?


## Step 5
Subset the data to only include patients who have experienced thoughts of suicide in the past 30 days. Determine the mean of perceived social support by friends in this group. Calculate a mean for the same variable among patients who have not experienced thoughts of suicide in the past 30 days.

Which group has a higher mean of perceived social support by friends?


## Step 6
Report the minimum and maximum scores and the means, medians, and standard deviations of the following variables:

a. Patients' Mental Component Scores at baseline.
b. Patients' Physical Component Scores at baseline.
