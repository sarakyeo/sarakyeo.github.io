...
Increasingly, data are important components of decision-making in businesses. Whether you are looking at industry trends, generating financial statements and reports, analyzing market data, or creating visuals to communicate your work, you will need to know how to analyze data to efficiently, accurately, and professionally to develop reports and effectively communicate your findings. This course will help you become familiar with R, a powerful data analysis tool.

Often, students ask why we use R instead of Microsoft Excel in this course.

Here are some comparisons of R and Excel that highlight the reasons for using R:
...
The image below, from [ModernDive Chapter 1](https://moderndive.com/1-getting-started.html) is a good illustration of the distinction between R and RStudio.

```{r echo = FALSE, fig.align = "center", fig.cap = "Analogy of the difference between R and RStudio. Source: [ModernDive Chapter 1](https://moderndive.com/1-getting-started.html)."}

knitr::include_graphics("images/R-vs-RStudio.png")

```

Throughout this course, you will be using R via RStudio. This means that you will need to have **both R and RStudio installed on your computer**.
