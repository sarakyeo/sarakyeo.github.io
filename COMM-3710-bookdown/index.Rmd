...
Figure \@ref(fig:R-vs-RStudio), from [ModernDive Chapter 1](https://moderndive.com/1-getting-started.html) is a good illustration of the distinction between R and RStudio [@mcconvilleStatisticalInferenceData2021].
...
Part of this [video](https://youtu.be/ZvPFKfNHBNQ) by Dr. Andy Field also describes the difference between R and RStudio. This video will also show you how to install R and RStudio, which are covered in Chapter \@ref(install).
