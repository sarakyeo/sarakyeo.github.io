...
Similarly, R packages need to be **installed** on your computer and then opened and then **loaded** in R. Note where quotation marks are used and omitted in the commands.
